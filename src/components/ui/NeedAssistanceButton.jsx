...
//
// Click → small popover with a single action: Schedule a Zoom →
// opens our own scheduler modal (slot picker → Zoom API → confirmation).
//
      ...
      {open && (
        ...
        >
          <div className="px-4 py-3 bg-gradient-to-br from-[#cc0000] to-[#8a0000] text-white">
            ...
            <p className="text-[13px] font-semibold leading-snug">Schedule a Zoom and we'll walk through it.</p>
          </div>
          <div className="p-2">
            <button
              type="button"
