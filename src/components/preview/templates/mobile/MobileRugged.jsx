...
export default function MobileRugged({ businessInfo, generatedCopy, templateMeta, images = {} }) {
  ...
  return (
    <div style={{ fontFamily: font, background: c.bg, color: c.text, minHeight: '100vh', overflowX: 'clip', margin: 0, padding: 0, containerType: 'inline-size', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* STATS BAR */}
      {present('statsBar') && (
      <section style={{ background: c.secondary || '#232e20', padding: '3.5rem 5%', borderBottom: `1px solid ${c.accent}33` , order: orderFor('statsBar') }}>
      ...
      {/* ABOUT + HOURS */}
      {present('about') && (
      <section id="about" style={{ background: c.secondary || '#232e20', padding: '80px 5%', borderTop: `1px solid ${c.accent}33` , order: orderFor('about') }}>
      ...
      {present('testimonials') && (
        ...
        <section style={{ padding: '80px 5%', borderTop: `1px solid ${c.accent}33` , order: orderFor('testimonials') }}>
      ...
      {/* CTA */}
      {present('cta') && (
      <section style={{ background: c.accent, padding: '72px 5%', textAlign: 'center' , order: orderFor('cta') }}>
